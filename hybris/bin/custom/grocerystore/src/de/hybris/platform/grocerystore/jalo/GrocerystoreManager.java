 ...
 */
package de.hybris.platform.grocerystore.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.grocerystore.constants.GrocerystoreConstants;
...
/**
 * This is the extension manager of the Grocerystore extension.
 */
public class GrocerystoreManager extends GeneratedGrocerystoreManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(GrocerystoreManager.class.getName());
	 ...
	 */
	public GrocerystoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GrocerystoreManager called.");
		}
	}
	 ...
	 */
	public static GrocerystoreManager getInstance()
	{
		return (GrocerystoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GrocerystoreConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GrocerystoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GrocerystoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
